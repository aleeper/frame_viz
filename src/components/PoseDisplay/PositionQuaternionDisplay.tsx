            ...
            <table className="min-w-full border-collapse">
              <tbody>
                <tr>
                  ...
                  <td className="px-2 py-1 text-right font-mono">{quaternion.x.toFixed(4)}</td>
                </tr>
                <tr>
                  <td className="px-2 py-1 text-right font-mono">y:</td>
                  <td className="px-2 py-1 text-right font-mono">{quaternion.y.toFixed(4)}</td>
                </tr>
                <tr>
                  <td className="px-2 py-1 text-right font-mono">z:</td>
                  <td className="px-2 py-1 text-right font-mono">{quaternion.z.toFixed(4)}</td>
                </tr>
                <tr>

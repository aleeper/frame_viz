...
// import { Controls } from 'three/src/extras/Controls';
...
class CustomTransformControls extends Controls {
  constructor(camera, domElement = null) {
    ...
    const gizmo = new CustomTransformControlsGizmo();
    this._gizmo = gizmo;
    root.add(gizmo);
  ...
  updateMatrixWorld(force) {
    ...
    if (controls.object !== undefined) {
      ...
      if (controls.object.parent === null) {
        console.error(
          'CustomTransformControls: The attached 3D object must be a part of the scene graph.'
        );
      } else {
...
export {
  ...
  CustomTransformControlsGizmo,
  CustomTransformControlsPlane,
};
